package com.spring.libraryMngSys.configuration;

import com.spring.libraryMngSys.service.MyUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/books/search").hasAnyAuthority(adminAuthority, studentAuthority)
